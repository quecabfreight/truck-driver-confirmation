...
/**
 * QueCab AdbS — Public Landing (isolated from app chrome)
 * - Uses a scoped root (#qsite) with its own reset so app styles don't leak in
 * - Big hero, value props, steps, features, pricing, testimonials, FAQ, footer
 * - Large readable type, wide layout, full-bleed gradient background
 */
...
export default function PublicSite() {
  ...
  return (
    <div id="qsite">
      {/* Scoped reset + design system (only applies inside #qsite) */}
      <style>{`
        ...
        #qsite .navWrap{
          ...
          background: linear-gradient(180deg, rgba(11,13,17,.88), rgba(11,13,17,.62));
        ...
        #qsite .btnPrimary{
          padding:12px 16px;border-radius:12px;font-weight:900;color:var(--ink);
          background: linear-gradient(180deg, var(--brand), #00d48a); border:1px solid var(--brand);
          box-shadow: 0 12px 30px rgba(0,255,162,.25);
        }
        ...
        #qsite .heroCard{
          ...
          border:1px solid var(--stroke); border-radius:18px; padding:24px; text-align:center;
        ...
        #qsite .dot{
          width:72px;height:72px;border-radius:12px;display:grid;place-items:center;font-weight:900;color:var(--ink);
        ...
        #qsite .tier.hot{border:2px solid var(--brand); background: linear-gradient(180deg, rgba(0,255,162,.16), rgba(0,255,162,.06)); box-shadow:0 14px 34px rgba(0,255,162,.22)}
        ...
        @media (max-width: 1000px){
          #qsite h1{font-size: 44px}
          #qsite .hero{grid-template-columns:1fr}
          #qsite .grid3, #qsite .grid2{grid-template-columns:1fr}
          #qsite .section{padding:56px 0}
        }
      `}</style>

      {/* NAV (no app header here) */}
      ...
      <section className="section" style={{paddingTop:24}}>
        <div className="wrap grid3">
          <div className="card" style={{textAlign:"center"}}>
            <div style={{fontSize:38,fontWeight:900}}>1 Link</div>
            <div>Driver & Dock share the same simple flow</div>
          </div>
          <div className="card" style={{textAlign:"center"}}>
            <div style={{fontSize:38,fontWeight:900}}>3 Checks</div>
            <div>USDOT# • Plate • Live driver call</div>
          </div>
          <div className="card" style={{textAlign:"center"}}>
            <div style={{fontSize:38,fontWeight:900}}>0 Nonsense</div>
      ...
      <section id="features" className="section">
        <div className="wrap">
          ...
          <div className="grid3">
            <div className="card">
              <h3>Dock-ready UI</h3>
              <p>Readable at a glance. Designed for noisy, fast-moving floors — not office monitors.</p>
            </div>
            <div className="card">
              <h3>Proof of call</h3>
              <p>Dock marks whether the driver answered. Eliminate “we tried” gray areas.</p>
            </div>
            <div className="card">
              <h3>Outcome signal</h3>
              <p>Clear green vs red result: <b>CLEAR TO LOAD</b> or <b>DO NOT LOAD</b>. No ambiguity.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          ...
          <div className="steps">
            <div className="card step">
              ...
              <div><b>Create an AdbS Verify Link</b> for each shipment. Share it by text — no login needed for drivers.</div>
            </div>
            <div className="card step">
              <div className="dot">2</div>
              <div><b>Driver confirms identity</b> with USDOT# & License Plate. Dock types what they see on the truck.</div>
            </div>
            <div className="card step">
              <div className="dot">3</div>
              <div>Dock <b>calls the driver</b>. All “Yes” → CLEAR TO LOAD; any “No” → DO NOT LOAD. Alerts go to the broker/shipper.</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid3">
            <div className="tier">
              <div style={{display:"flex",justifyContent:"space-between"}}>
                <h3>Starter</h3><div className="price">$— /mo</div>
              </div>
              <ul>
                <li>Single dock</li>
            ...
            <div className="tier hot">
              <div style={{display:"flex",justifyContent:"space-between"}}>
                <h3>Pro</h3><div className="price">$— /mo</div>
              </div>
              <ul>
            ...
            <div className="tier">
              <div style={{display:"flex",justifyContent:"space-between"}}>
                <h3>Enterprise</h3><div className="price">Custom</div>
              </div>
              <ul>
      ...
      <section id="faq" className="section">
        <div className="wrap">
          ...
          <div className="grid2">
            <div className="card">
              <h3>Do drivers need an app?</h3>
              <p>No. They tap a link sent by text. Done.</p>
            </div>
            <div className="card">
              <h3>What if the dock can’t reach the driver?</h3>
              <p>Mark “No” to the call question. The system flags DO NOT LOAD.</p>
            </div>
            <div className="card">
              <h3>Does this replace our TMS?</h3>
              <p>No. It runs alongside your ops. Pro/Enterprise can integrate later.</p>
            </div>
            <div className="card">
              <h3>Who can request access?</h3>
              <p>Brokers & shippers only. Drivers don’t need accounts.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="wrap footRow">
          <div>
            <h3 style={{margin:0}}>QueCab AdbS™</h3>
        ...
        <div className="wrap" style={{marginTop:16,opacity:.7}}>
          © {year} QueCab AdbS — All rights reserved.
        </div>
      </footer>
    </div>
  );
