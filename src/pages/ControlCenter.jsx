    ...
    try {
      ...
      setStatusMsg(
        data.email_status === "sent"
          ? "AdbS Verification issued and emailed."
          : data.email_status === "failed"
          ? "AdbS Verification issued, but email failed."
          : "AdbS Verification issued."
      );
            ...
            {issued && (
              <div style={{ marginTop: 14 }}>
                ...
                {(issued.carrier_company || issued.carrier_contact_name || issued.carrier_contact_phone) && (
                  ...
                  >
                    <div style={{ fontWeight: 900, marginBottom: 8, color: "#ffffff" }}>
                      Carrier Contact
                    </div>
